...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('home-thumbs', 150, 100, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lightslider', get_template_directory_uri() . '/js/lib/lightslider.min.js', array(), '1.0'); // Lightslider
        ...
        wp_register_script('swiper', get_template_directory_uri() . '/js/lib/swiper.min.js', array(), '4.0'); // Swiper
...
{
    if (is_page('home')) {
        wp_register_script('hp-slideshow', get_template_directory_uri() . '/js/hp-slideshow.js', array('jquery'), '1.0.0'); // Conditional script(s)
        wp_enqueue_script('hp-slideshow'); // Enqueue it!
    }
}
...
function my_acf_google_map_api( $api ){
 ...
 $api['key'] = 'AIzaSyDF5DNWFC0FIyFFMDrEXGoIjZqikNw-9vQ';
